-- Internal workshop sales: complete sale for profit/stock, no safe movement, no AR.

DROP FUNCTION IF EXISTS public.create_completed_invoice(
  text, jsonb, numeric, numeric, numeric, numeric, numeric, text,
  uuid, uuid, uuid, text, timestamptz, uuid, uuid
);
...
COMMENT ON FUNCTION public.create_completed_invoice(
  text, jsonb, numeric, numeric, numeric, numeric, numeric, text,
  uuid, uuid, uuid, text, timestamptz, uuid, uuid, boolean
) IS 'Create completed invoice; p_for_workshop skips safe/AR for shared-treasury internal issues';
