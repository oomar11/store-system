...
أضف على Vercel Environment Variables:

```
GEMINI_API_KEY=...
TELEGRAM_WEBHOOK_SECRET=...   # سلسلة عشوائية قوية
```

ثم من الإعدادات → **مساعد جارفس** → تفعيل المساعد (يسجّل webhook على `/api/telegram/webhook`).
